...
client.once(Events.ClientReady, async c => {
    ...
    const commands = [
        new SlashCommandBuilder().setName('order').setDescription('Start a new order ticket (Staff only)').addAttachmentOption(o => o.setName('reference').setDescription('Optional image/doc').setRequired(false)),
        new SlashCommandBuilder().setName('review').setDescription('Submit a review').addUserOption(o => o.setName('employee').setDescription('Employee').setRequired(true)),
        new SlashCommandBuilder().setName('portfolio').setDescription('Post your portfolio')
    ].map(cmd => cmd.toJSON());
